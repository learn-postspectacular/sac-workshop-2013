...
class RhomboGroup {
  ...
  RhomboGroup(Vec2D sp, int gen) {
    ...
    Vec2D n1 = new Rhombohedron(new Vec2D(300, 300), L, THETA, PI/3).poly.get(2);
    Vec2D n2 = new Rhombohedron(new Vec2D(300, 300), L, THETA, PI).poly.get(2);
    Vec2D n3 = new Rhombohedron(new Vec2D(300, 300), L, THETA, -PI/3).poly.get(2);
